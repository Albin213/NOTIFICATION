...
function Section1() {
  return (
    <div className='relative flex flex-col lg:flex-row px-4 sm:px-[30px] lg:px-[74px] pt-14'>
        ...
        <p className='text-[#222020] font-normal text-[24px] 2xl:text-[30px]  leading-8 2xl:leading-10 pt-8 sm:me-24 xl:me-64'>Ready To Enhance Your Data Infrastructure With PI System Consulting Or Database Services? 
        ...
        <div className='text-white text-[20px]  lg:text-[24px] 2xl:text-[30px] font-medium p-16 flex justify-center items-center text-center rounded-3xl bg-[#05525F]'>
        PI System <br/>
        Consulting
        </div>
        <div className='text-white text-[20px] lg:text-[24px] 2xl:text-[30px]  font-medium p-16 flex justify-center items-center text-center rounded-3xl bg-[#2A8E9E] mt-4'>
        Database System <br/>
        Consulting
        </div>

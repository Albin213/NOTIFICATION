...
//       wjkfejwfgefeiferifgreugureugeu
//       iofeifheiu
//       </div>
...
function Page() {
  ...
  return (
    <div className="bg-[#F7FBFB] w-full h-full relative">
      ...
      {showPopup && (
        <div
          className="w-screen h-screen fixed top-0 left-0 bg-[#0000009c] flex justify-center items-center z-50"
          onClick={closePopup} // Close when clicking outside
        >
          <div className="relative  rounded-lg shadow-lg" onClick={(e) => e.stopPropagation()}>
            <button
              className="absolute top-0 sm:top-3 right-3  rotate-45 text-5xl sm:text-7xl text-gray-400 hover:text-gray-600"
              onClick={closePopup}
            >
              +
            </button>

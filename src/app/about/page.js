  ...
  return (
    ...
    <div className='px-4 sm:px-[30px] lg:px-[74px] py-10  drop-shadow-xl pb-16 xl:pb-32'>
        <div className='bg-white rounded-[34px] px-6 sm:px-24 xl:px-28 py-12 relative'>
            <img src="right.png" alt="" className='absolute right-0 top-0 w-0 sm:w-auto' />
            <img src="left.png" alt="" className='absolute left-0 bottom-0 w-0 sm:w-auto' />

            <p className='text-[#1B1A1A]  text-[20px] sm:text-[24px] pt-4 sm:pt-14 pb-6 sm:pb-14 font-normal leading-10  poppins-regular sm:text-justify capitalize'>

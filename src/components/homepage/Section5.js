...
function Section5() {
  ...
  return (
    <div className=" w-full section5-bg ">
      {/* Header */}
     <div className="px-4 sm:px-[30px] lg:px-[74px] pt-20 2xl:pb-40  ">
     <h1 className="font-normal text-[30px] sm:text-[40px] xl:text-[50px] text-[#023347] sm:text-center jomolhari-regular">
      Mobile App Development
      </h1>
      <h1 className="text-[26px] xl:text-[36px] poppins-regular text-[#023347] mt-12">Build Powerful & Scalable Mobile Applications</h1>
      <p className="text-[22px] sm:text-[26px] lg:text-[30px] font-normal text-[#023347] sm:leading-10 pt-4 md:pt-8  poppins-regular sm:text-justify capitalize">
     ...
     <div className="py-20 section5-bg px-4 sm:px-[30px] lg:px-[74px] section5-bg-img">
         {/* Services Grid */}
      <h1 className="text-[30px] sm:text-[40px] lg:text-[50px] text-[#023347] font-normal text-center jomolhari-regular">Our Expertise</h1>
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-x-4 gap-y-6 pt-16 poppins-regular">
        {/* Service 1 */}
        <div
          ref={(el) => (divRefs.current[0] = el)}
          className={`font-normal text-[20px] sm:text-[28px] text-[#023347] bg-gradient-to-r from-[#89C0C9] via-[#E9F2F4] to-[#EBF4F5] p-16 text-center flex justify-center items-center rounded-[7px] drop-shadow-md transition-all duration-700 ease-out transform ${
        ...
        <div
          ...
          className={`font-normal text-[20px] sm:text-[27px] text-[#023347] bg-gradient-to-r from-[#89C0C9] via-[#E9F2F4] to-[#EBF4F5] p-16 text-center flex justify-center items-center rounded-[7px] drop-shadow-md transition-all duration-700 ease-out transform ${
